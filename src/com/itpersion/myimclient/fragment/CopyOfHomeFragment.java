 ...
 * @Description:登陆成功主页面
 */
public class CopyOfHomeFragment extends FragmentActivity {
	private ViewPager mPager;
	private ArrayList<Fragment> fragmentsList;
	private TextView tvTabActivity, tvTabGroups, tvTabFriends, tvTabChat,
			tv_tab_unmesscount;
	private LinearLayout ll_message,ll_context;
